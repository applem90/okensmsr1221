...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/3a3f1a72-73b8-41fd-b211-3ec10f6dd670"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="3a3f1a72-73b8-41fd-b211-3ec10f6dd670"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/b033af50-a9e1-46ee-b6a2-8af9e9b4ebfd"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="b033af50-a9e1-46ee-b6a2-8af9e9b4ebfd"
fi
echo ${Vmess_UUID}
